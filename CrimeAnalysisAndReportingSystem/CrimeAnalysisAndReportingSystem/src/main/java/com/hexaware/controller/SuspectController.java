...
/*
 * The SuspectController class manages a list of suspects, interacting with the SuspectsDao
 * to populate and display suspect information. It provides methods to populate the list 
 * and display details about the suspects.
 */
