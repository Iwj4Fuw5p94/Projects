...
/*
 * The ReportController class manages a list of reports, interacting with the ReportsDao
 * to populate, add, and display report information. It provides methods to populate the list,
 * add new reports, display report details, and retrieve a report by its ID. 
